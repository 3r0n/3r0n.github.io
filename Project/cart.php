...
switch($_GET["action"]) 
{
	case "add":
		if(!empty($_POST["quantity"]))
        {
            ...
            $itemArray = array($sql[0]['tankid'] => array('type'=>$sql[0]["type"], 'quantity'=>$_POST["quantity"], 'color'=>$sql[0]["color"], 'price'=>$productByCode[0]["price"]));
...
<div id="product-grid">
	...
	<?php
    //runs query and save contents in array
	$product_array = $db_handle->runQuery("SELECT * FROM tblproduct ORDER BY id ASC");
    
    //print contents in array
