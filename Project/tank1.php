            ...
            <div class="row">
                ...
                <div class="col-md-3">
                  ...
                  <div class="list-group panel">
                    ...
                    <a href="tank1.php" class="list-group-item list-group-item-info active">Tank Tops</a>
                ...
                <div class="col-md-9">
                    ...
                    <?php
                        ...
                        while($row = mysqli_fetch_assoc($result))
                        {
                            ...
                            echo "<input type='submit' class='btn btn-success pull-right' name='submit1'>";
                            echo "<br><br>";
...
<?php
	 ...
	 if(isset($_POST['submit1']))
        ...
        //getting product id
	  $pquery=" SELECT TanksID FROM tanks WHERE Size='$size'";
...
$Quanquery=" SELECT Price FROM tanks  WHERE Size='$size'";				
