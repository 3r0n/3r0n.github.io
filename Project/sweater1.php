            ...
            <div class="row">
                ...
                <div class="col-md-3">
                  ...
                  <div class="list-group panel">
                    ...
                    <a href="sweater1.php" class="list-group-item list-group-item-info active">Sweaters</a>
                ...
                <div class="col-md-9">
                    ...
                    <?php
                        ...
                        {
                            echo "<form method='post'  action='sweater1.php'>";
                            ...
                            echo "<h3>" . "Type: ". $row['Type'] . "<br>" . "Size: " . $row['Size'] . "<br>" . "Quantity: " . $row["Quantity"]."<br>";
                            echo "<br>";

							
							echo "Enter Amount :<input type='number' name='testquantity' max='".$row['Quantity']."' required> <br>";
							
							echo "Enter Shirt Size:<input type='text' name='size' required> <br><br>";
							
                            echo "<input type='submit' class='btn btn-success pull-right' name='submit2'>";
                            echo "<br><br>";
...
<?php
	 ...
	 if(isset($_POST['submit2']))
	  ...
	  //getting product id
	  $pquery=" SELECT SweaterID FROM sweater WHERE Size='$size'";
...
$Quanquery=" SELECT Price FROM sweater WHERE Size='$size'";				
		...
		while($row = mysqli_fetch_assoc($Quanresult))
	  	...
	  	$Total=($DQUAN*$testquantity);			
	   $insert1=" INSERT INTO orderstatus(CustomerID,ProductID,Product_Quan, total) VALUES ('$CID','$SID','$testquantity','$Total')";
	   //$CID;
	   //$SID;
	  //echo "user input". $testquantity;
	  //echo "user input". $DQUAN;
		  ...
		  //$Quantitynew=($DQUAN - $testquantity);
		   ...
		   /* query to run update once the cumputation of the old  subtracted the new it was storied in the 
		     Quantitynew variable which is used to update the quantity field in the database.
		       */
		   /*$sql2=" UPDATE sweater SET Quantity='$Quantitynew' WHERE Size='$size' AND Type='$type'";
		   if(mysqli_query($Connection, $sql2))
                ...
                {
                    echo "error Updating into table";
